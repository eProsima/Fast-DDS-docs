...
void xml_dyn_examples_check()
{
    ...
    {
        //XML-STRUCT
        DynamicType_ptr long_type = DynamicTypeFactory::get_instance().create_int32_type();
        DynamicType_ptr long_long_type = DynamicTypeFactory::get_instance().create_int64_type();
