...
extlinks = {
    ...
    "fastdds-python-tree": (
        f"https://github.com/eProsima/Fast-DDS-python/tree/{fastdds_python_branch}/%s", "%s"
    ),
    # Fast-DDS-docs repo (code examples embedded in the docs repo)
    "fastdds-docs-tree": (
        f"https://github.com/eProsima/Fast-DDS-docs/tree/{fastdds_fallback_branch}/%s", "%s"
    ),
    # Fast-DDS-Gen raw files
    "fastddsgen-raw": (
        f"https://raw.githubusercontent.com/eProsima/Fast-DDS-Gen/{fastdds_fallback_branch}/%s",
        "%s",
    ),
}
...
.. |FastDDSPythonBranch| replace:: {fastdds_python_branch}
"""
