...
# built documents. This is the Basic Fast DDS version only - see
# `logo_version_html` below for the combined Basic/Pro display under the logo.
#
# The short X.Y version.
version = fastdds_version
# The full version, including alpha/beta/rc tags.
release = fastdds_version
