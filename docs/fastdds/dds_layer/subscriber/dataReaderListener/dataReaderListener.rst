...
:cpp:class:`eprosima::fastdds::dds::DataReaderListener` is an abstract class defining the callbacks
...
:cpp:class:`eprosima::fastdds::dds::DataReaderListener` defines the following callbacks:

* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_data_available`:
  There is new data available for the application on the :ref:`dds_layer_subscriber_dataReader`.

* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_subscription_matched`:
...
* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_requested_deadline_missed`:
  The :ref:`dds_layer_subscriber_dataReader` didn't receive
...
* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_requested_incompatible_qos`:
  The :ref:`dds_layer_subscriber_dataReader` has found a
  :ref:`dds_layer_publisher_dataWriter` that matches the :ref:`dds_layer_topic_topic` and has
...
.. note::
   Currently :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_requested_incompatible_qos`
   is not implemented (it will never be called), and will be implemented on a future release of Fast DDS.

* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_liveliness_changed`:
...
* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_sample_rejected`:
  A received data sample was rejected.

* :cpp:func:`eprosima::fastdds::dds::DataReaderListener::on_sample_lost`:
