...
:cpp:class:`eprosima::fastdds::dds::SubscriberListener` is an abstract class defining the
...
:cpp:class:`eprosima::fastdds::dds::SubscriberListener` inherits from
...
callbacks that ::cpp:class:`eprosima::fastdds::dds::SubscriberListener` inherits from
:ref:`dds_layer_subscriber_dataReaderListener`
will only be called if the triggering :ref:`dds_layer_subscriber_dataReader` has
no Listener attached.

Additionally, :cpp:class:`eprosima::fastdds::dds::SubscriberListener` adds the following callback:

 * :cpp:func:`eprosima::fastdds::dds::SubscriberListener::on_data_on_readers`:
