...
+---------------------+---------------------+--------------------------------------------------------------------------+
| Discovery Service   | |SERVER|            | The DomainParticipant acts as a hub for discovery traffic, receiving     |
...
|                     |                     | This type of sever makes the Discovery Service architecture              |
|                     |                     | resilient |br| to server destruction.                                    |
+---------------------+---------------------+--------------------------------------------------------------------------+
