...
*eProsima Fast RTPS-Gen* is a Java application that generates source code using the data types defined in an
...
For this project, we will use the Fast RTPS-Gen application to define the data type of the messages that will be sent
