...
This class overrides the default DataWriter listener callbacks, which allows the execution of routines in case of an event.
...
DataWriter.
This is a member in the |MatchedStatus-python-api| structure that allows tracking changes in the status of subscriptions.
