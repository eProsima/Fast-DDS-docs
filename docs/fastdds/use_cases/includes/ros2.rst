...
This tutorial is an explanation of how to take full advantage of Fast DDS wide set of capabilities in a ROS 2 project.
...
As described in :ref:`xml_profiles` section, there are two possibilities for providing Fast DDS with XML configuration
files:
...
The following example uses the ROS 2 talker/listener demo, configuring Fast DDS to publish synchronously, and to have a
