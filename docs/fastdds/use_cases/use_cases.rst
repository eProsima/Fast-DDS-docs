...
+ :ref:`use-case-reduceMemory`.
  For use cases were available memory is scarce this example presents configuration options to reduce memory footprint
  to a minimum by tweaking the :ref:`dds_layer_core_policy`
