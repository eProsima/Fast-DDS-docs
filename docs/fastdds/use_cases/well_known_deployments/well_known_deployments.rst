...
However, if all :ref:`DomainParticipants<dds_layer_domainParticipant>` are known beforehand,
...
:ref:`dds_layer_domainParticipant`, allowing to arrange which participant will communicate with which.
This reduces the amount of meta traffic if not all the :ref:`DomainParticipants<dds_layer_domainParticipant>`
