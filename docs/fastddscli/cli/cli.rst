...
| Verbs                    | Description                                                                               |
+==========================+===========================================================================================+
| ``discovery``            | Launches a server for :ref:`Discovery Service <discovery_service>`.                       |
+--------------------------+-------------------------------------------------------------------------------------------+
...
Launches a server for :ref:`Discovery Service <discovery_service>`. This server will manage the messages of the
