...
#. XTypes refactor:
    ...
    #. Implementation of ``DynamicData`` to JSON serializer.
    #. Implementation of ``DynamicType`` to IDL serializer.
...
#. Make private previously public API:
    ...
    #. Make RTPS reader implementations private.
    #. Make RTPS writer impl private.
