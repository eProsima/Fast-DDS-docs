...
There are different settings that allow to distinguish between applications where data is updated periodically and
...
Besides the liveliness kind, two additional parameters allow to define the application behaviour. They are all listed
in the table below.
